...
const Test = () => {
    ...
    let value=["Test","Value 2","Value 3","Value 4","Value 5","Value 6","Value 7","Value 8","Value 9","Value 10"]
  return (
    <div>
...
<div className='flex justify-center items-center mt-14 '>
       ...
       <li className='flex gap-6 items-center font-[30px] text-[#696671] font-[Inter] '>
           ...
           <ul onClick={()=>{navigate('/Text')}} className=' border-b-2 border-blue-950 text-blue-900 text-[Inter]'>
              Text
           </ul>
